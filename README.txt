...
traiter, analyser et visualiser des données étudiantes, afin d'aider
les professeurs et les étudiants à mieux evaluer d'une part les
...
B- Analyser les erreurs de programmation des étudiants pour
...
de texte (environnement de developpement intégré). Avoir le
repertoire Data qui aura tous les fichiers .txt qui eux
contiennent les informations des étudants et leurs erreurs.
Très important, le repertoire Data et les fichiers python
...
"python nom_du_fichier_a_executer.py" pour executer le 
projet ou une partie spécifique du projet.
B. Pour le Lot2, il faut d'abord executer le fichier
"structuration.py" et en suite le fichier Chat_Bot.py.
...
C- Reseaux: chynelsoki50@gmail.com
            tarazayasmine0@gmail.com
            salmaaa0912@gmail.com

Lien GitHub du projet : https://github.com/chynel/SAE1.02
